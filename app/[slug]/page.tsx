...
export default async function Page({ params }: Params) {
  ...
  // Do not disclose that a private draft exists at this slug. The host route
  // still handles unpublished rows separately for the organizer login.
  if (resolved.status === "unpublished") notFound();
